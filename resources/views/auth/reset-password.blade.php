                                ...
                                <div class="card-body p-4">
                                    ...
                                    <div class="p-2 mt-4">
                                        <div class="alert alert-success text-center mb-4" role="alert">
                                            Votre mot de passe sera modifié
                                        </div>
                                        <form method="POST" action="{{ route('password.update') }}">
                                            ...
                                            <div class="mb-3">
                                                <label class="form-label" for="useremail">Email</label>
                                                <input type="password" name="password" class="form-control" id="password" placeholder="Entrer email">
                                            </div>

                                            <div class="mb-3">
                                                <label class="form-label" for="useremail">Email</label>
                                                <input type="password" name="password_confirmation" class="form-control" id="password_confirmation" placeholder="Entrer email">
                                            </div>
